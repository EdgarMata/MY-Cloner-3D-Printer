...
#define STRING_CONFIG_H_AUTHOR "(Edgar Mata, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ME-Cloner"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -34, -16, -1.2  }
