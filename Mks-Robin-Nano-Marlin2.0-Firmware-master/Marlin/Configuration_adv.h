...
#define SENSORLESS_BACKOFF_MM  { 10, 2, 0 }  // (mm) Backoff from endstops before sensorless homing
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define Z4_CURRENT_HOME Z4_CURRENT/2
    #define Z4_MICROSTEPS    Z_MICROSTEPS
    ...
    #define I_CURRENT_HOME I_CURRENT/2
    #define I_MICROSTEPS    16
    ...
    #define J_CURRENT_HOME J_CURRENT/2
    #define J_MICROSTEPS    16
    ...
    #define K_CURRENT_HOME K_CURRENT/2
    #define K_MICROSTEPS    16
